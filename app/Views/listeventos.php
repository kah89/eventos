                    ...
                    <table class="table table-hover " id="atividades">
                        ...
                        <tbody>
                            <?php foreach ($data as $key => $evento) {
                               ...
                               <td><a class="btn btn-primary" href="#" data-toggle="modal" data-target="#certificadoModal" onclick="preenchermodal(' . $evento['id'] . ');" role="button">Gerar</a></td></tr>';
                            } ?>
                        </tbody>
                    </table>
                <?php } ?>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="<?= base_url("/eventos/gerarCertificado")."/" ?>" class="btn btn-primary disabled" id="btnEmitir">Emita aqui seu certificado!</a>
                            </div>
                        </div>
                    </div>
                </div>
