<main>
            ...
            <div class="tab-pane col fade" id="nav-certificado" role="tabpanel" aria-labelledby="nav-certificado-tab">
                ...
                <div id="certificado_pane" class="col-12" style="padding: 40px;display:none;">
                    ...
                    <div class="text-right">
                        ...
                        <a id="certBtn" onclick="emitirCertificado();" class="btn btn-success" style="cursor: no-drop; pointer-events: none;">Emita aqui seu certificado!</a>
    ...
    <script>
        ...
        var horaEvento = new Date("Mar 23, 2021 18:30:00").getTime();

        var fimEvento = new Date("Mar 24, 2021 18:35:00").getTime();
        ...
        var horaEvento2 = new Date("Mar 24, 2021 18:30:00").getTime();

        //Hora de término

        var horaTerminoEvento2 = new Date("Mar 24, 2021 22:00:00").getTime();
